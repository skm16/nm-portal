...
--
-- Table structure for table `csr_lead`
--

DROP TABLE IF EXISTS `csr_lead`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `csr_lead` (
  ...
  `EventWebsite` varchar(500) DEFAULT NULL,
  `EventDates` text,
  `EventCosts` text,
  `FundingExplanation` text,
  `CollectingMethod` text,
  `PreviousReimbursement` tinyint DEFAULT NULL,
  `Commitment` tinyint DEFAULT NULL,
...
--
-- Dumping data for table `csr_lead`
--

LOCK TABLES `csr_lead` WRITE;
/*!40000 ALTER TABLE `csr_lead` DISABLE KEYS */;
/*!40000 ALTER TABLE `csr_lead` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-09-02 13:42:20
