<?php
/**
 * Template Name: Advertising Reimbursement
 * Template for submitting advertising reimbursement requests
 *
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="reimbursement-header">
					<h1><i class="fa fa-dollar"></i> Advertising Reimbursement</h1>
					<p class="lead">Request reimbursement for print, digital, and outdoor advertising costs</p>
				</div>
				...
				<?php else : ?>
					<?php echo nmda_render_advertising_reimbursement_form( $approved_businesses ); ?>
				<?php endif; ?>
