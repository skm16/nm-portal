		...
		<div class="dashboard-header">
			<div class="row align-items-center">
				...
				<div class="col-md-4 text-right">
					<span class="last-login">Last login: <?php echo human_time_diff( strtotime( $user->user_login ), current_time( 'timestamp' ) ); ?> ago</span>
				</div>
			</div>
		</div>
					...
					<div class="row mt-4 dashboard-stats">
						...
						<div class="col-md-3">
							<div class="stat-card">
								...
								<div class="stat-content">
									<h3><?php echo human_time_diff( get_the_time( 'U', $business_id ), current_time( 'timestamp' ) ); ?></h3>
									<p>Member Since</p>
								</div>
							</div>
						</div>
					...
					<div class="row mt-4">
						<div class="col-md-12">
							<div class="card quick-actions-card">
								<div class="card-body">
									<h3 class="card-title"><i class="fa fa-flash"></i> Quick Actions</h3>
									<div class="row">
										<div class="col-md-4">
						...
						<div class="col-md-8">
							<div class="card business-profile-card">
								<div class="card-header">
									<h3><i class="fa fa-building"></i> Business Profile</h3>
								</div>
								<div class="card-body">
									<div class="business-header">
										...
										<div class="business-info">
											<h2><?php echo esc_html( $business_post->post_title ); ?></h2>
											<?php
									...
									<div class="text-right mt-3">
										...
										<a href="<?php echo get_permalink( $business_id ); ?>" class="btn btn-outline-secondary" target="_blank">
											<i class="fa fa-external-link"></i> View Public Profile
										</a>
									</div>
								</div>
							</div>
