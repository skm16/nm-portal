<?php
/**
 * Template Name: Lead Generation Reimbursement
 * Template for submitting lead generation reimbursement requests
 *
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="reimbursement-header">
					<h1><i class="fa fa-dollar"></i> Lead Generation Reimbursement</h1>
					<p class="lead">Request reimbursement for trade shows, events, and promotional activities</p>
				</div>
				...
				<?php else : ?>
					<?php echo nmda_render_lead_reimbursement_form( $approved_businesses ); ?>
				<?php endif; ?>
